...
suite("Value table query statement generation", function() {
    ...
    test("Query with column count restriction equal to requested column count", function() {
    ...
    test("Query with column count restriction greater then requested column count", function() {
        ...
        expect(statement.statement).to.be("SELECT j4.value,j5.value,j7.value,j8.value,j9.value,j10.value,j3.id,NULL,NULL,NULL FROM json_values j1,json_values j2,json_values j3,json_values j4,json_values j5,json_values j6,json_values j7,json_values j8,json_values j9,json_values j10 WHERE j1.id=TO_NUMBER(:const1) AND j2.parent_id=j1.id AND j2.name=:const2 AND j3.parent_id=j2.id AND j4.parent_id=j3.id AND j4.name=:const3 AND j5.parent_id=j3.id AND j5.name=:const4 AND j6.parent_id=j3.id AND j6.name=:const5 AND j7.parent_id=j6.id AND j7.name=:const6 AND j8.parent_id(+)=j6.id AND j8.name(+)=:const7 AND j9.parent_id=j6.id AND j9.name=:const8 AND j10.parent_id(+)=j3.id AND j10.name(+)=:var1");
    
    });

    test("Query with column count restriction less then requested column count", function() {
        ...
        expect(statement.statement).to.be("SELECT j4.value,j5.value,j7.value,j8.value,j9.value FROM json_values j1,json_values j2,json_values j3,json_values j4,json_values j5,json_values j6,json_values j7,json_values j8,json_values j9,json_values j10 WHERE j1.id=TO_NUMBER(:const1) AND j2.parent_id=j1.id AND j2.name=:const2 AND j3.parent_id=j2.id AND j4.parent_id=j3.id AND j4.name=:const3 AND j5.parent_id=j3.id AND j5.name=:const4 AND j6.parent_id=j3.id AND j6.name=:const5 AND j7.parent_id=j6.id AND j7.name=:const6 AND j8.parent_id(+)=j6.id AND j8.name(+)=:const7 AND j9.parent_id=j6.id AND j9.name=:const8 AND j10.parent_id(+)=j3.id AND j10.name(+)=:var1");
