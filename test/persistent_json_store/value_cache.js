suite("JSON value LRU cache tests", function() {
    ...
    setup("Reset value cache, check cache content", function() {
        ...
        database.call("persistent_json_store.reset_value_cache");

        let cache = database.call("persistent_json_store.get_cached_values");
    ...
    test("Try setting NULL cache capacity", function() {
        ...
        expect(function() {
            ...
            database.call("persistent_json_store.set_value_cache_capacity", {
                p_capacity: null
            });
    ...
    setup("Create several anonymous values, set cache capacity", function() {
        ...
        for (let i = 1; i <= 6; i++) {
            ...
            let valueId = database.call("persistent_json_store.create_json", {
                p_content_parse_events: [`Svalue_${i}`]
            });
    ...
    test("Try getting a value with NULL ID", function() {
        ...
        expect(function() {
            ...
            let value = database.call("persistent_json_store.get_value", {
                p_id: null
            });
    ...
    test("Retrieve a value, check cache content", function() {
        ...
        database.call("persistent_json_store.get_value", {
            p_id: values[0].id
        });
